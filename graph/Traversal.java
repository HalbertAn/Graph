 ...
 *  marked vertices.
 *  @author alberthan with pseudocode from P. N. Hilfinger's Lecture code
 */
public abstract class Traversal {
    ...
    protected Traversal(Graph G, Queue<Integer> fringe) {
        ...
        postvistvertices = new ArrayList<>();
    }
    ...
    public void traverse(Collection<Integer> V0) {
        ...
        while (!_fringe.isEmpty()) {
            ...
            if (!marked(v)) {
                ...
                if (shouldPostVisit(v) && !postvistvertices.contains(v)) {
                    postVisit(v);
                    postvistvertices.add(v);
                }
            }
        }
    }
    ...
    /** postvisted vertices. */
    private ArrayList<Integer> postvistvertices;
